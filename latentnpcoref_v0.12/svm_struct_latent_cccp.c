...
int resize_cleanup(int size_active, int **ptr_idle, double **ptr_alpha, double **ptr_delta, double **ptr_gammaG0,
                   double **ptr_proximal_rhs, double ***ptr_G, DOC ***ptr_dXc, double **ptr_cut_error);
...
void my_read_input_parameters(int argc, char *argv[], char *trainfile, char *modelfile,
    ...
    learn_parm->eps = 0.5; // tree-edge loss not within 0 and 1
...
int resize_cleanup(int size_active, int **ptr_idle, double **ptr_alpha, double **ptr_delta, double **ptr_gammaG0,
    ...
    double *gammaG0 = *ptr_gammaG0;
    double *proximal_rhs = *ptr_proximal_rhs;
    double **G = *ptr_G;
    DOC **dXc = *ptr_dXc;
    double *cut_error = *ptr_cut_error;
    ...
    *ptr_delta = delta;
    *ptr_gammaG0 = gammaG0;
    *ptr_proximal_rhs = proximal_rhs;
    *ptr_G = G;
    *ptr_dXc = dXc;
    *ptr_cut_error = cut_error;
