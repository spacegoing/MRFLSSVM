...
__PYX_EXTERN_C DL_EXPORT(void) pythonAdd(int *); /*proto*/
__PYX_EXTERN_C DL_EXPORT(int) *numpyArray(int, int); /*proto*/
...
int *numpyArray(int __pyx_v_rows, int __pyx_v_cols) {
